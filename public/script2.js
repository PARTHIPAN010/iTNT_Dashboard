const sectionsData = {
  C1: "Entrepreneurs benefitted (attendees from A1+A2+A3) (innovation Aspirants)",
  C2: "Startups Supported & Mentored (A1+A2+A3) (Portfolio startups)",
  C3: "Community Engagement (A1+A2+A3)",
  C4: "Deep tech and Emerging Tech investors",
  C5: "MoU's with Colleges for JIGSAW Platform",
  C6: "Researchers onboarded onto JIGSAW Platform",
  C7: "EoIs with international ecosystem players",
  C8: "MoU with Ecosystem Enablers (Industry, incubators etc)",
  C9: "Product Launches"
};
...
function addEventInput(container, code) {
  ...
  // ❌ Don't add buttons for C1, C2, C3
  ...
  editEventBtn.onclick = () => {
    ...
    buttonsRow.querySelectorAll("button").forEach(btn => (btn.disabled = false));
    editEventBtn.style.display = "none";
  };
